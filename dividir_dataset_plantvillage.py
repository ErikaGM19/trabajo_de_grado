...
# CONFIGURACIÓN
# =============================================
DIRECTORIO_ORIGEN = "Data/PlantVillage/train"  
DIRECTORIO_VAL    = "Data/PlantVillage/val"
DIRECTORIO_TEST   = "Data/PlantVillage/test"

PORCENTAJE_VAL  = 0.10   # 10% para validación
PORCENTAJE_TEST = 0.10   # 10% para test
# El 80% restante se queda en train
...
for clase in clases:
    ...
    # El resto se queda en train (no se mueve)
...
print(f"   - train : 80% de las imágenes")
print(f"   - val   : 10% de las imágenes")
print(f"   - test  : 10% de las imágenes")